...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <Link href="https://tally.so/r/3y8G66" target="_blank">
              <Button className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 text-sm md:px-6 md:text-base transition-all duration-200">
                Get Free Demo
              </Button>
            </Link>
          </div>
      ...
      {/* Hero Section */}
      <section className="py-18 md:py-28 bg-gradient-to-br from-gray-50 via-blue-50 to-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-7 md:mb-10 leading-tight">
            Turn Missed Calls Into
            <span className="text-blue-600"> Paying Customers</span>
          </h1>
          <p className="text-lg md:text-2xl text-gray-700 mb-10 md:mb-14 max-w-4xl mx-auto leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center mb-14 md:mb-18">
            <Link href="https://tally.so/r/3y8G66" target="_blank">
              <Button
                size="lg"
                className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-8 py-4 md:px-10 md:py-5 text-lg md:text-xl font-semibold transition-all duration-200 hover:scale-105 shadow-lg"
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            {stats.map((stat, index) => (
              <div
                key={index}
                className="text-center bg-white/80 p-4 md:p-5 rounded-xl border border-gray-200 shadow-sm"
              >
      ...
      <section className="py-14 md:py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-10">
            {/* Problem Side */}
            <div className="bg-red-50 p-6 md:p-7 rounded-2xl border-2 border-red-200">
              ...
              <div className="mt-5 p-4 bg-red-100 rounded-lg border border-red-300">
            ...
            {/* Solution Side */}
            <div className="bg-green-50 p-6 md:p-7 rounded-2xl border-2 border-green-200">
              <div className="flex items-center mb-5">
              ...
              <div className="mt-5 p-4 bg-green-100 rounded-lg border border-green-300">
                <p className="text-green-700 font-semibold text-center text-sm md:text-base">
          ...
          <div className="grid lg:grid-cols-3 gap-6 md:gap-7">
            <Card className="bg-white border-gray-200 hover:border-blue-300 transition-all duration-300 shadow-lg hover:shadow-xl">
              <CardContent className="p-5 md:p-7 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Instant Answer</h3>
                ...
                <div className="text-xl font-bold text-blue-600">100% Capture Rate</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-gray-200 hover:border-blue-300 transition-all duration-300 shadow-lg hover:shadow-xl">
              <CardContent className="p-5 md:p-7 text-center">
                ...
                <h3 className="text-lg font-semibold text-gray-900 mb-4">Smart Booking</h3>
                <p className="text-gray-600 mb-4 text-sm md:text-base">
                ...
                <div className="text-xl font-bold text-blue-600">Instant Bookings</div>
              </CardContent>
            </Card>
            ...
            <Card className="bg-white border-gray-200 hover:border-blue-300 transition-all duration-300 shadow-lg hover:shadow-xl">
              <CardContent className="p-5 md:p-7 text-center">
                ...
                <div className="text-xl font-bold text-blue-600">$35K+ Monthly</div>
              </CardContent>
            </Card>
          </div>
        </div>
      ...
      {/* CTA Section */}
      <section className="py-14 md:py-20 bg-gradient-to-r from-blue-600 to-blue-700">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl md:text-4xl font-bold text-white mb-4 md:mb-6">
            Stop Losing Customers During Off-Hours
          </h2>
          <p className="text-base md:text-xl text-blue-100 mb-8 md:mb-10 max-w-3xl mx-auto">
            <strong>
          ...
          <Link href="https://tally.so/r/3y8G66" target="_blank">
            <Button
              size="lg"
              className="bg-white text-blue-600 hover:bg-gray-100 px-8 py-4 md:px-10 md:py-5 text-lg md:text-xl font-semibold transition-all duration-200 hover:scale-105 shadow-lg"
            >
              Apply for Free Custom Demo
              <ArrowRight className="ml-3 h-5 w-5 md:h-6 md:w-6" />
            </Button>
          </Link>
          <p className="text-blue-100 mt-5 text-sm md:text-base">
      ...
      {/* Footer */}
      <footer className="bg-gray-900 py-10 md:py-14 border-t border-gray-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex items-center space-x-3 mb-4 md:mb-0">
              <Image src="/logo.png" alt="Tiham AI Studio" width={28} height={28} className="w-7 h-7" />
              <span className="text-lg font-bold text-white">Tiham AI Studio</span>
            </div>
            <p className="text-gray-400 text-sm">© 2024 Tiham AI Studio. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
